    ...
    public function toHtml($event = null)
    {
        ...
        $html =
            ...
            $html .=
                    ...
                    ((empty($robotMedia->FileURI)) ? '' : '<a href="' . TEAMS_URL . 'photos.php?eventId=' . $event->BlueAllianceId . '&teamId=' . $this->Id . '">') .
                ...
                '</header>
                    <div class="mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                        ...
                        <div class="mdl-card__actions">
                            <a href="' . TEAMS_URL . 'matches.php?eventId=' . $event->BlueAllianceId . '&teamId=' . $this->Id . '" class="mdl-button">View</a>
                        </div>
                    </div>
                </section>';
