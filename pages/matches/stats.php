...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    $navBarLinksArray = new NavBarLinkArray();
    $navBarLinksArray[] = new NavBarLink('Stats', MATCHES_URL . 'stats?eventId=' . $event->BlueAllianceId . '&matchId=' . $match->Key . ((!empty($team)) ? '&teamId=' . $team->Id : ''), true);
    $navBarLinksArray[] = new NavBarLink('Blue Alliance', MATCHES_URL . 'match?eventId=' . $event->BlueAllianceId . '&matchId=' . $match->Key . '&allianceColor=BLUE' . ((!empty($team)) ? '&teamId=' . $team->Id : ''));
    $navBarLinksArray[] = new NavBarLink('Red Alliance', MATCHES_URL . 'match?eventId=' . $event->BlueAllianceId . '&matchId=' . $match->Key . '&allianceColor=RED' . ((!empty($team)) ? '&teamId=' . $team->Id : ''));
    $navBarArray[] = new NavBar($navBarLinksArray);
